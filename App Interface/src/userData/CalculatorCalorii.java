...
//{"Sedentary", "Sport 1-3 days/week", "Sport 3-5 days/week", "Sport 6-7 days/week"};
	...
	public int calculateCalories() {
		int MC = 0;
		if(this.getGender().equals(Gender.Female.toString())) 
			MC = (int) (10 * this.getWeight() + 6.25 * this.getHeight() - 5 * this.getAge() + 5);
			else if(this.getGender().equals(Gender.Male.toString()))
	...
	public void setCaloriesFromUserData(GreekUser gu) {
		this.setActivity(gu.getActivity());
		this.setAge(gu.getAge());
		this.setGender(gu.getGender().toString());
		this.setGoals(gu.getGoals());
		this.setHeight(gu.getHeight());
		this.setWeight(gu.getWeight());		
	}

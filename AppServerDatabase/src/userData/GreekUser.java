 ...
 */
@Entity
@Table(name="greek_user")
@NamedQuery(name="GreekUser.findAll", query="SELECT g FROM GreekUser g")
public class GreekUser implements Serializable {
	...
	//bi-directional many-to-one association to UserFood
